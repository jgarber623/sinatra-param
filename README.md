...
sinatra-param is developed using Ruby 2.4.5 and is additionally tested against Ruby 2.5.5 and 2.6.2 using [Travis CI](https://travis-ci.com/jgarber623/sinatra-param).
...
gem 'sinatra-param', git: 'https://github.com/jgarber623/sinatra-param', tag: 'v2.3.0'
```

If you're using Bundler 2.0, you may simplify the `Gemfile` line to:

```ruby
gem 'sinatra-param', github: 'jgarber623/sinatra-param', tag: 'v2.3.0'
```
